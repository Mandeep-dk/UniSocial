...
<div className='flex w-screen flex-row justify-between items-center px-4 sm:px-6 lg:px-8 py-3 shadow-md bg-white'>
                ...
                <div className='relative'>
                    <button onClick={handleDropDown}>
                        <img
                            ...
                            className="h-9 w-9 sm:h-14 sm:w-14 rounded-full object-cover border-2 border-gray-200 hover:border-rose-500 transition-colors"
                            alt='profile'
                        />
                    </button>
                </div>
            ...
            {openDropDown &&
                <div className='absolute top-16 sm:top-20 right-4 sm:right-10 flex flex-col bg-white shadow-lg border rounded-lg p-4 z-50 w-48 sm:w-52'>
